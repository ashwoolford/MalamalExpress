  ...
  const renderItem = ({ item }) => {
    return (
      <View style={styles.divFood}>
        <Text>Created on: <Text style={{ fontWeight: 'bold' }}>{item.date}</Text></Text>
        <Text>Time: <Text style={{ fontWeight: 'bold' }}>{item.time}</Text></Text>
        <Text>Item(s): <Text style={{ fontWeight: 'bold' }}>{item.total_items}</Text></Text>
        <Text>Price: <Text style={{ fontWeight: 'bold' }}>{item.total} ৳</Text></Text>
      </View >
    )
  }
